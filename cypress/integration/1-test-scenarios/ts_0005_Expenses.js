...
describe("TC_EP_001 validate query selector functionality ", () => {
  ...
  it("User should be signed and to be able to successfully submit new expense", () => {
    ...
    cy.get(
      '[format="MMMM do hh:mm aaaa"] > .MuiInputBase-root > .MuiInputBase-input'
    )
      .click()
      .wait(500);
    cy.log("after dates window open");
    cy.get(
      ":nth-child(1) > .MuiButtonBase-root > .MuiButton-label > .MuiTypography-root"
    ).click();
    ...
    cy.get(
      ":nth-child(3) > :nth-child(2) > .MuiButtonBase-root > .MuiIconButton-label > .MuiTypography-root"
    ).click();
  ...
  it("Should visit EXPENSES page", () => {
    cy.get(
      '[href="/expenses/all"] > .MuiButtonBase-root > .MuiButton-label'
    ).click();
